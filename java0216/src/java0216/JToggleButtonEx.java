...
public class JToggleButtonEx extends JFrame {
		...
		if(tbStart == null) {
			...
			tbStart.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(JToggleButtonEx.this, "Start");
				}
			});
		}
		return tbStart;
	...
	public JToggleButton getTbStop() {
		if(tbStop == null) {
			...
			tbStop.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(JToggleButtonEx.this, "Stop");
				}
			});
		}
		return tbStop;
	...
	public static void main(String[] args) {
	    SwingUtilities.invokeLater(new Runnable() {
	        public void run() {
	        	JToggleButtonEx jFrame = new JToggleButtonEx();
