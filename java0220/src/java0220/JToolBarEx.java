...
public class JToolBarEx extends JFrame {
	...
	private ActionListener actionListener = new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnNew) {
				JOptionPane.showMessageDialog(JToolBarEx.this, "[새로만들기]를 클릭");
			} else if (e.getSource() == btnSave) {
				JOptionPane.showMessageDialog(JToolBarEx.this, "[저장]을 클릭");
			} else if (e.getSource() == btnCopy) {
				JOptionPane.showMessageDialog(JToolBarEx.this, "[복사]를 클릭");
			} else if (e.getSource() == btnPaste) {
				JOptionPane.showMessageDialog(JToolBarEx.this, "[붙여넣기]를 클릭");
			}
		}
	};
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				JToolBarEx jFrame = new JToolBarEx();
